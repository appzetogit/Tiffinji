        ...
        {profileOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed inset-0 w-full h-full min-h-screen bg-white z-50 overflow-y-auto flex flex-col"
              onClick={(e) => e.stopPropagation()}
            >
              {/* Header */}
              ...
              <div className="px-6 py-5">
                <button
                  ...
                  className="w-full flex items-center gap-4 text-left p-4 bg-gradient-to-br from-slate-50 to-orange-50/30 border border-slate-200/80 rounded-2xl hover:border-primary/40 hover:shadow-md transition-all group"
                >
                  {/* Avatar */}
                  <div className="w-14 h-14 bg-white rounded-2xl flex items-center justify-center shrink-0 overflow-hidden shadow-sm ring-2 ring-primary/20 group-hover:ring-primary/40 transition-all">
                    {userProfileImage ? (
                      <img
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center justify-between gap-2 mb-1">
                      ...
                      <span className="inline-flex items-center gap-1 text-xs font-semibold text-primary bg-primary/10 px-2.5 py-0.5 rounded-full shrink-0">
                    ...
                    <span className="inline-block text-[10px] font-black text-amber-700 uppercase tracking-wider bg-amber-50 px-2 py-0.5 rounded border border-amber-200/60 mt-1">
                      {userData.role}
                    </span>
                  </div>
                </button>
              ...
              <div className="px-6 pb-6 space-y-3">
                ...
                <button
                  ...
                  className="w-full bg-slate-50 text-slate-700 border border-slate-200 hover:bg-slate-100 active:scale-[0.99] disabled:opacity-50 disabled:cursor-not-allowed font-medium py-3 px-4 rounded-xl transition-all flex items-center justify-between group"
                >
                  <div className="flex items-center gap-3">
                    <div className="bg-blue-50 p-2 rounded-lg text-blue-600">
                      <Bell className={`w-4 h-4 ${isTestingNotification ? "animate-bounce" : ""}`} />
                    </div>
                    <span className="text-sm font-semibold">{isTestingNotification ? "Sending test..." : "Test Notification"}</span>
                  </div>
                ...
                <button
                  ...
                  disabled={isLoggingOut}
                  className="w-full bg-primary text-white hover:bg-primary/95 active:scale-[0.99] disabled:opacity-50 disabled:cursor-not-allowed font-bold py-3.5 px-4 rounded-xl shadow-md shadow-primary/20 transition-all flex items-center justify-center gap-2"
                >
                ...
                <button
                  ...
                  className="w-full flex items-center justify-between gap-3 rounded-xl border border-rose-200/80 bg-rose-50/40 px-4 py-3 text-left hover:bg-rose-50 hover:border-rose-300 transition-all active:scale-[0.99] group"
                >
                  <div className="flex items-center gap-3 min-w-0">
                    ...
                    <div className="min-w-0">
                      <p className="text-sm font-bold text-rose-600">Delete Restaurant Account</p>
                      <p className="text-xs text-rose-500/80">Permanently remove this account</p>
                    </div>
                  </div>
